...
public class lcogenServicelmpl implements lcogenService {
	...
	*/
	...
	@Override
	public List<lcotgen> listaUnRegistro(int opcion, String p_ciacont, String p_ejer, lcotgen obj) {
		return repository.listaUno(opcion, p_ciacont, p_ejer, obj.getPkID().getTl_codtabla(), obj.getPkID().getTl_clave(),
				obj.getTl_descri(), obj.getTl_descri2(), obj.getTl_usrcrea(), obj.getTl_feccrea(), obj.getTl_hracrea(),
				obj.getTl_usract(), obj.getTl_fecact(), obj.getTl_hraact());
	}
	...
	@Override
	public void registrarNuevoRegistro(int opcion, String p_ciacont, String p_ejer, lcotgen obj) {
		repository.registrarRegistro(opcion, p_ciacont, p_ejer, obj.getPkID().getTl_codtabla(), obj.getPkID().getTl_clave(),
				obj.getTl_descri(), obj.getTl_descri2(), obj.getTl_usrcrea(), obj.getTl_feccrea(), obj.getTl_hracrea(),
				obj.getTl_usract(), obj.getTl_fecact(), obj.getTl_hraact());
	...
	@Override
	public void editarRegistro(int opcion, String p_ciacont, String p_ejer, lcotgen obj) {
		repository.actualizaRegistro(opcion, p_ciacont, p_ejer, obj.getPkID().getTl_codtabla(), obj.getPkID().getTl_clave(),
				obj.getTl_descri(), obj.getTl_descri2(), obj.getTl_usrcrea(), obj.getTl_feccrea(), obj.getTl_hracrea(),
				obj.getTl_usract(), obj.getTl_fecact(), obj.getTl_hraact());
	}
	...
	@Override
	public void eliminarRegistro(int opcion, String p_ciacont, String p_ejer, lcotgen obj) {
		repository.eliminaRegistro(opcion, p_ciacont, p_ejer, obj.getPkID().getTl_codtabla(), obj.getPkID().getTl_clave(),
				obj.getTl_descri(), obj.getTl_descri2(), obj.getTl_usrcrea(), obj.getTl_feccrea(), obj.getTl_hracrea(),
				obj.getTl_usract(), obj.getTl_fecact(), obj.getTl_hraact());
	...
	@Override
	public List<Map<String, Object>> swListarAnexos3(int opcion, String p_ejer, String p_ciacont) {
		return repository.ListarAnexos3(opcion, p_ciacont, p_ejer);
	}
}
