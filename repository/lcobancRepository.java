...
@Repository
public interface lcobancRepository extends JpaRepository<lcobanc, lcobancPk> {
        ...
        List<Map<String, Object[]>> listarCaj(@Param("opcion") int opcion,
        ...
        @Query(value = "{call SP_CrudLcoBanc(:opcion, :p_ciacont, :bl_codbco, :bl_nombco," +
                        ...
                        " :bl_nche3, :bl_frche, :bl_modesdcta, :bl_usrcrea, :bl_feccrea, :bl_hracrea, :bl_usract," +
                        " :bl_fecact, :bl_hraact)}", nativeQuery = true)
        List<Map<String, Object[]>> listarBco(@Param("opcion") int opcion,
                        @Param("p_ciacont") String p_ciacont,
                        @Param("bl_codbco") String bl_codbco,
                        @Param("bl_nombco") String bl_nombco,
                        @Param("bl_tipmon") String bl_tipmon,
        ...
        @Query(value = "{call SP_ActualizarChequera(:opcion, :cia, :codigo, :nro_chequera, :cheque)}", nativeQuery = true)
        @Modifying
        @Transactional
        void modificarChequera(@Param("opcion") int opcion,
                        @Param("cia") String cia,
                        @Param("codigo") String codigo,
                        @Param("nro_chequera") String nro_chequera,
